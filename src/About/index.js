      ...
      <div className="about-box-container">
        <Paper elevation={3} className="about-box">
          ...
          <p className="description">
            View, sort and filter without having to worry about tampering with the existing document!
            <br />
        ...
        <Paper elevation={3} className="about-box">
          ...
          <p className="description">
            Pick a handful of people by this handy tool!
            You can set wheel speed and label used on your discretion.
            People who are drawn will be removed from the available pool.
            Retrieve your list right next to the wheel.
